...
import { useCreateTicket, useUsers } from 'modules/Ticket/ticket.hook';
import { ICreateTicketData, IEditTicketParams } from 'modules/Ticket/type';
import { ticketTypesList } from 'modules/Ticket/ticket.constants';

export const WidgetTicketCreationForm = ({
  open,
  setOpen,
  data,
}: {
...
export const TestIngWidget = () => {
  return <WidgetTicketCreationForm open={false} setOpen={(a) => {}} />;
};
