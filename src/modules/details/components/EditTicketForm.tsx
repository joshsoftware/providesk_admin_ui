...
import { getAllowedStatus, editTicketValidationSchema as validationSchema } from '../details.helpers';
...
export const EditTicketForm = ({
  ...
  const allowedStatuses = getAllowedStatus(userAuth.role, ticket);
